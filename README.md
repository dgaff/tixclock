...
You read the time by counting the number of lit squares for each digit, e.g. it's 12:34 in the picture. To keep things interesting for folks who don't know how to read the clock, the squares change regularly. The clock will still say 12:34, but it will be a different set of dots lit up. This version of the TIX Clock is no longer made, and folks on ebay are selling them for several hundred dollars!! Apparently there's a [version two](https://tixclock.shop/) coming at some point.
